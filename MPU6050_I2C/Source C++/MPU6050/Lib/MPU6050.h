...
class MPU6050:protected I2C {
	...
	public:
		...
		virtual MPU6050::ACC_RANGE getAccRange() {
			return this->accRange;
		}
		virtual MPU6050::GYRO_RANGE getGyroRange() {
		...
		virtual float getGyroXGravity() {
			return gyroX_G;
		}
		virtual float getGyroYGravity() {
			return gyroY_G;
		}
		virtual float getGyroZGravity() {
			return gyroZ_G;
		}
